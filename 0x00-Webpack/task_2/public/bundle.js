...
(() => {
  var t = {
        ...
        function r(t, r) {
          for (var o = {}, u = [], a = 0; a < t.length; a++) {
            ...
            -1 !== p
              ...
              : e.push({ identifier: l, updater: i(h, r), references: 1 }),
              u.push(l);
          }
          return u;
        }
      ...
      868: (t, e, n) => {
        "use strict";
        t.exports = n.p + "1ffccecda515c7c70c2d.jpg";
      },
    },
    e = {};
  function n(r) {
  ...
  (n.m = t),
    ...
    (() => {
      ...
      const v = n(755),
        g = n(486);
      let y = 0;
      const m = v("<button>Click here to get started</button>").on(
        "click",
        g.debounce(
          function () {
            y++, v("#count").text(`${y} clicks on the button`);
          },
          500,
          { leading: !0, trailing: !1 }
        )
      );
      v("body").append("<div id='logo'></div>"),
        v("body").append("<p>Holberton Dashboard</p>"),
        v("body").append("<p>Dashboard data for the students</p>"),
        v("body").append(m),
        v("body").append("<p id='count'></p>"),
        v("body").append("<p>Copyright - Holberton School</p>");
    })();
})();
